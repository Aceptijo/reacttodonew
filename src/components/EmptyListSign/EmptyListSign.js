...
import "./EmptyListSign.sass";

const EmptyListSign = () => {
  return (
    <div className="App__emptyListSign">
      <svg
        className="App__emptyList-logo"
        width="60px"
        height="60px"
        viewBox="0 0 60 60"
        fill="#3c3c3c"
      >
        <path
          className="App__emptyList-logo-starPath"
          d="M58.453,45.101c-0.116-0.367-0.434-0.634-0.814-0.688l-7.777-1.089l-3.472-6.78c-0.342-0.668-1.438-0.668-1.779,0
          ...
          c0.148,0.29,0.429,0.489,0.751,0.534l6.225,0.872L50.816,50.312z"
        />
        <path d="M11.5,2h34v30h2V0h-36h-10v60h10h20v-2h-20V2z M3.5,58V2h6v56H3.5z" />
      ...
      <span className="App__emptyList-title">You don't have any task :(</span>
    </div>
  );
};

export default EmptyListSign;
